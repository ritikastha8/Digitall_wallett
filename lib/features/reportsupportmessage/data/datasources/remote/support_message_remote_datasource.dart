...
final supportMessageRemoteDatasourceProvider =
    Provider<SupportMessageRemoteDatasource>((ref) {
      return SupportMessageRemoteDatasource(
        apiClient: ref.read(apiClientProvider),
      );
    });

class SupportMessageRemoteDatasource
    implements ISupportMessageRemoteDatasource {
  ...
  @override
  Future<SupportMessageApiModel> updateMessage(
    String id,
    String message,
  ) async {
