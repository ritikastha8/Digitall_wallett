...
class SupportMessageViewModel extends Notifier<SupportMessageState> {
  ...
  SupportMessageState build() {
    ...
    _createSupportMessageUsecase = ref.read(
      createSupportMessageUsecaseProvider,
    );
    _updateSupportMessageUsecase = ref.read(
      updateSupportMessageUsecaseProvider,
    );
    _deleteSupportMessageUsecase = ref.read(
      deleteSupportMessageUsecaseProvider,
    );
